...
//Documents exports stricter limiting
Route::middleware(['auth:sanctum', 'throttle:25,1','verified'])->group(function () {
...
Route::middleware(['auth:sanctum', 'throttle:application','verified'])->group(function () {
    // Documents
    ...
    Route::get('/applications/find', [ApplicationController::class, 'findForCall']);
